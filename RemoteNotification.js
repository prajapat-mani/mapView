...
const RemoteNotification = () => {
    useEffect(() => {
        ...
        // Using this function as we are rendering local notification so without this function we will receive multiple notifications for the same notification
        // We have the same channelID for every FCM test server notification.
        ...
        PushNotification.configure({
            ...
            onNotification: function (notification) {
                ...
                PushNotification.createChannel(
                    {
                        ...
                        channelName: "remote message", // (required)
                ...
                PushNotification.localNotification({
                    channelId: key, // this must be the same with channelId in createChannel
                    title: strTitle,
                    message: strBody,
                });
